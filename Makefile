...
TEST_ROMS = $(TEST_OBJECTS:.o=.rom)
TEST_ELFS = $(TEST_OBJECTS:.o=.out)
TEST_DEPS = $(TEST_OBJECTS:.o=.d)

.PHONY: default
default: $(AUTOGENERATED_HEADERS) game.rom $(TEST_ROMS)
...
$(LIBGB_BUILD_DIR) $(GAME_BUILD_DIR) $(TEST_BUILD_DIR):
	mkdir -p $@
...
$(TEST_BUILD_DIR)/%.rom: $(TEST_BUILD_DIR)/%.out | $(TEST_BUILD_DIR)
	$(OBJ_COPY) -O binary $< $@ --gap-fill 0
