...
static constexpr auto very_little_star_tile_2 = build_tile({{
    {C0, C0, C0, C0, C0, C0, C0, C0},
    {C0, C0, C0, C0, C0, C0, C0, C0},
    {C0, C0, C0, C0, C0, C0, C0, C0},
    {C0, C0, C0, C0, C0, C0, C0, C0},
...
static consteval auto register_star_sprites(libgb::TileRegistry &registry,
  ...
  scene.register_sprite_tile(registry, very_little_star_tile_2);
...
static auto animate_stars(uint8_t frame_count) -> void {
  ...
  if (frame_count % 4 == 0) {
    ...
    static constexpr auto very_little_frame_2 =
        scene_manager.sprite_tile_index(0, very_little_star_tile_2);
